...
const policyGroups = [
  {
    ...
    items: [
      '카카오 로그인, 닉네임, 채팅/거래 기록, 배송지 정보는 서비스 제공과 분쟁 대응을 위해 처리합니다.',
      '배송지와 연락처는 해당 거래의 판매자에게만 전달되며 거래 목적 외 사용을 금지합니다.',
      '회원 탈퇴 시 계정은 비활성화되지만 전자상거래 및 분쟁 대응에 필요한 거래 기록은 법령상 보관 기간 동안 보관될 수 있습니다.',
    ],
  },
  {
    title: '이용약관',
    ...
    items: [
      'CardBid는 구매자와 판매자를 연결하는 통신판매중개 서비스입니다.',
      '허위 매물, 타인의 사진 도용, 외부 결제 유도, 정산과 배송 방해 행위를 제한합니다.',
      '입찰과 즉시구매는 실제 구매 의사로 간주되며, 정당한 사유 없는 미결제는 이용 제한 사유가 될 수 있습니다.',
    ],
  },
  {
    title: '환불·거래정책',
    ...
    items: [
      ...
      '상품 미발송, 설명과 다른 상품, 위조 의심 등은 채팅 기록과 사진을 기준으로 확인합니다.',
      '단순 변심 환불은 판매자와 합의가 필요하며, 외부 거래는 플랫폼 보호 대상에서 제외될 수 있습니다.',
    ],
  },
];
...
export default function LegalNoticeScreen() {
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      >
        <DetailPageHeader eyebrow="POLICY" title="약관 및 거래정책" />

        <View style={styles.noticeBox}>
          <ThemedText style={styles.noticeTitle}>거래 전 꼭 확인해주세요</ThemedText>
          <ThemedText style={styles.noticeText}>
            카드 상태, 구성품, 배송 방식, 결제 조건은 거래 당사자가 직접 확인해야 합니다. 분쟁이 생기면 채팅 기록,
            사진, 송장 정보를 기준으로 확인합니다.
          </ThemedText>
        </View>
...
const styles = StyleSheet.create({
  ...
  noticeTitle: { color: palette.ink, fontSize: 15, fontWeight: '900', lineHeight: 21, marginBottom: 6 },
  ...
  sectionTitle: { color: palette.ink, flex: 1, fontSize: 16, fontWeight: '900', lineHeight: 22 },
