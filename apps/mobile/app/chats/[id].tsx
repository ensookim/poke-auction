...
const styles = StyleSheet.create({
  ...
  senderName: { color: '#667085', fontSize: 12, fontWeight: '800', marginBottom: 4 },
  ...
  messageText: { color: '#111827', fontSize: 16, lineHeight: 22 },
  myMessageText: { color: '#111827' },
  myMessageMeta: { alignItems: 'flex-end', gap: 2 },
  readText: { color: '#2563EB', fontSize: 11, fontWeight: '800' },
  timeText: { color: '#98A2B3', fontSize: 11, marginBottom: 2 },
  inputBar: {
    alignItems: 'flex-end',
    backgroundColor: '#FFFFFF',
    borderColor: '#EEF0F4',
